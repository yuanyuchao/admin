        ...
        <Layout>
            <Header class="header-con">
                <header-bar :collapsed="collapsed" @on-coll-change="handleCollapsedChange">
                    ...
                    <user :message-unread-count="unreadCount" :user-avator="userAvator" @logout="logout"/>
                    <ScanCode />
            ...
            <Content class="main-content-con">
                <Layout class="main-layout-con">
                    <div class="tag-nav-wrapper">
                        <tags-nav :value="$route" @input="handleClick" :list="tagNavList" @on-close="handleCloseTag" ref="tagsNav"/>
                    </div>
...
<script>
    ...
    import ScanCode from './components/code/Index'
    ...
    export default {
        ...
        methods: {
            ...
            logout() {
                this.$refs.tagsNav.handleTagsOption('all')
            }
        },
        watch: {
            '$route' (newRoute) {
